...
function MainSection2() {
  ...
  return (
    <div className="flex flex-row items-end justify-center relative w-full h-screen bg-cover bg-center snap-start scroll-smooth overflow-hidden">
        ...
        <div className="flex flex-row items-center justify-center w-[80%] h-full">
          ...
          <div className="flex flex-col-reverse items-center justify-center">
            <div className="flex flex-col items-start justify-start w-[450px]">
            ...
            <div className="flex flex-col items-start w-[500px] min-w-[400px] mb-[50px]">
