        ...
        <>
            <div className="absolute w-full h-[200px] z-0 pointer-events-none ">
                <div className="absolute top-0 left-0 w-full h-full">
                    <RadioWave color="#872341" time="animate-radioWave1 mt-1" />
                </div>
                <div className="absolute top-0 left-0 w-full h-full">
                    <RadioWave color="#F05741" time="animate-radioWave1 mt-3"/>
                </div>
                <div className="absolute top-0 left-0 w-full h-full">
                    <RadioWave color="#872341" time="animate-radioWave1 mt-5" />
                </div>
            </div>
            <div className="absolute w-full h-[200px] z-0 pointer-events-none ">
                <div className="absolute top-0 left-0 w-full h-full">
                    <RadioWave color="#F05741" time="animate-radioWave1 mt-7" />
                </div>
                <div className="absolute top-0 left-0 w-full h-full">
                    <RadioWave color="#872341" time="animate-radioWave1 mt-9"/>
                </div>
                <div className="absolute top-0 left-0 w-full h-full">
                    <RadioWave color="#F05741" time="animate-radioWave1 mt-11" />
                </div>
            </div>
            <div className="absolute w-full h-[200px] rotate-180 z-0 pointer-events-none ">
                <div className="absolute bottom-0 left-0 w-full h-full">
                    <RadioWave color="#872341" time="animate-radioWave1"/>
                </div>
                <div className="absolute bottom-2 left-0 w-full h-full">
                    <RadioWave color="#F05741" time="animate-radioWave1" />
                </div>
